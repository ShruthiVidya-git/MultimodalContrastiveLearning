...
class SimCLR(object):
    def __init__(self, dataset, config):
        ...
        self.writer = SummaryWriter(log_dir='/content/drive/MyDrive/Summer_Project-ECE_697/ConVIRT Pytorch')
    ...
    def train(self):
        ...
        #Checkpoint folder
        model_checkpoints_folder = '/content/drive/MyDrive/Summer_Project-ECE_697/ConVIRT Pytorch'#os.path.join(self.writer.log_dir, 'checkpoints')
    ...
    def _load_pre_trained_weights(self, model):
        try:
            checkpoints_folder = '/content/drive/MyDrive/Summer_Project-ECE_697/ConVIRT Pytorch/checkpoints'#os.path.join('./runs', self.config['fine_tune_from'], 'checkpoints')
